...
public class ColorUtil {
     ...
     * @return The result
     * @deprecated This can produce jarring leaps between very different colors in the middle of an
     * interpolation. For an alternative, see {@code GTColor.lerp()} in the
     * <a href="https://github.com/CypherCove/gdx-tween">gdx-tween library</a>,
     * particularly with {@code ColorSpace.DegammaLmsCompressed}.
     * */
    @Deprecated
